...
jQuery.noConflict()(function ($) {
    ...
    function getRandomTxt(){
        return "Normal Function Text";
    }
    function customField(rKey){
        $.post('script.php', { key: rKey}, function(result) { 
            return result; 
         });
    }
     ...
     function tlt(){
        ...
        var title1 = "Static variable text";
        var title2 = getRandomTxt();
        var title3 = customField("title_3");
